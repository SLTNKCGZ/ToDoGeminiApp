...
import os
#auth_router adında bir değişken oluşturuyoruz ve bu değişken routers2/auth.py dosyasından gelir.
#todo_router adında bir değişken oluşturuyoruz ve bu değişken routers2/todo.py dosyasından gelir.
